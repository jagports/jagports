-- Synthetic MVP stock-storage fixtures for local/UI/API development and tests.
...
INSERT INTO stock_location (id, site_id, parent_id, location_type, name) VALUES
  (57110, 57101, NULL, 'shelf', 'Shelf A'),
  ...
  (57120, 57102, NULL, 'shelf', 'Shelf A'),
...
INSERT INTO stock_item (
  ...
  (57140, 'FIXTURE-STOCK-A', 2, 'fixture', 'available', 'Shelf A / Box 1', 'fixture', 'fixture:571:stock:a', 1, 'B', 57111, 57130, 25.00, 'EUR'),
  (57141, 'FIXTURE-STOCK-B', 1, 'fixture', 'available', 'Shelf A / Box 1 / BoxSub1 / BoxSub2', 'fixture', 'fixture:571:stock:b', 1, 'C', 57113, 57130, 12.50, 'EUR'),
  (57142, 'FIXTURE-STOCK-C', 3, 'fixture', 'available', 'Shelf B / Box 2', 'fixture', 'fixture:571:stock:c', 1, 'A', 57115, 57130, 40.00, 'EUR'),
  (57143, 'FIXTURE-STOCK-D', 1, 'fixture', 'available', 'Secondary / Shelf A / Box 1', 'fixture', 'fixture:571:stock:d', 1, 'D', 57121, 57130, 8.00, 'EUR');
