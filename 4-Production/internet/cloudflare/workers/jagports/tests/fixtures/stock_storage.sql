...
-- Quality identity is condition_code. The legacy/supplementary condition text is
-- intentionally NULL here; localized presentation belongs to i18n resources.
...
INSERT INTO stock_item (
  ...
  (57140, 'FIXTURE-STOCK-A', 2, NULL, 'available', 'Rack A / Shelf A / Box 1', 'fixture', 'fixture:571:stock:a', 1, 'A', 57111, 57130, 40.00, 'EUR'),
  (57141, 'FIXTURE-STOCK-B', 1, NULL, 'available', 'Rack A / Shelf A / Box 1 / BoxSub1', 'fixture', 'fixture:571:stock:b', 1, 'B', 57112, 57130, 25.00, 'EUR'),
  (57142, 'FIXTURE-STOCK-C', 1, NULL, 'available', 'Rack A / Shelf A / Box 1 / BoxSub1 / BoxSub2', 'fixture', 'fixture:571:stock:c', 1, 'C', 57113, 57130, 12.50, 'EUR'),
  (57143, 'FIXTURE-STOCK-D', 1, NULL, 'available', 'Shelf B / Box 2', 'fixture', 'fixture:571:stock:d', 1, 'D', 57115, 57131, 8.00, 'EUR'),
  (57144, 'FIXTURE-STOCK-E', 1, NULL, 'available', 'Rack A / Shelf A / Box 1', 'fixture', 'fixture:571:stock:e', 1, 'E', 57121, 57131, 0.00, 'EUR');