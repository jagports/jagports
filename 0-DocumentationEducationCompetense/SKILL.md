...
- `00-Management/PRIORITIZATION.md` for scoring, Issue Priority/Rank, PR Priority/Rank, Workstream evidence, automatic-on-open behavior, explicit `@priorize`, and Product Owner authority.
