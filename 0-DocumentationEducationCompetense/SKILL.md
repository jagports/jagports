...
- `00-Management/PRIORITIZATION.md` for scoring, Issue Priority plus Issue Project Item Rank, PR Project Item Priority/Rank, Workstream evidence, automatic-on-open behavior, explicit `@priorize`, and Product Owner authority.
