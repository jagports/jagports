...
- `00-Management/PRIORITIZATION.md` for scoring, Issue Priority plus shared Project Band and Issue Rank, PR Project Item Priority/shared Band/PR Rank, Workstream evidence, automatic-on-open behavior, explicit `@priorize`, and Product Owner authority.
