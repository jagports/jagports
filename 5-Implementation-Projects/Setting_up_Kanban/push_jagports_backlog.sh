...
Initial status: $init_status"
  ...
  # Retry item-id lookup — gh project item-list can lag behind item-add
  item_id=""
...
# --- P1.3 onward (P1, P1.1, P1.2 already created — see recovery steps) ---
...
echo "Backlog pushed. Check the Project:"
