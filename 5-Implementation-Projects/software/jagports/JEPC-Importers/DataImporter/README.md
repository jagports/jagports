...
$selection = node src/DataImporter.CLI.mjs select-xk --source "C:\Program Files\JEPC\applications\JEPC" --state-dir "$env:LOCALAPPDATA\Jagports\JEPC-Importer" --seed "xk-selection-1" --json | ConvertFrom-Json
