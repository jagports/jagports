...
- The file does not define real Jagports inventory.
- The file does not define deployment, migration, runtime-validation, or search implementation procedure.
- The file does not certify fitment or supersession facts beyond the repository fixture/test boundary.
