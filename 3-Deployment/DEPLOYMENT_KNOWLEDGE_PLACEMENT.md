...
- `3-Deployment/` contains deployment knowledge and related deployment processes.
- `4-Production/` contains production runtime and implementation components organized by their actual deployment/domain hierarchy.
